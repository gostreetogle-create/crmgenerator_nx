...
Тут при необходимости лежат **заархивированные** чек-листы фич, которые:
...
- не плодить дубликаты чек-листов одной и той же фичи;
- хранить снимок «что было сделано» в прошлой итерации.
