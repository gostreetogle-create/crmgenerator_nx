...
> Единый файл в корне `docs/`. Дубль-указатель: [`docs/ai/PROMPTS.md`](ai/PROMPTS.md).
...
```text
Добавь в libs/ui-kit новый презентационный компонент "<Name>" по docs/ai/COMPONENT_TEMPLATE.md и ARCHITECTURE.md:
