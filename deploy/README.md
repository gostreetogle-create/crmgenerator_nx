...
Важно: это **не ежедневная обязанность**. Используй этот файл только в нужный момент:
- когда вышли новые изменения в GitHub и нужно обновить сервер,
- когда нужно проверить состояние сервиса,
- когда нужно разобрать ошибку или восстановить БД.
...
Когда нужно обновить сервер после изменений в GitHub:
